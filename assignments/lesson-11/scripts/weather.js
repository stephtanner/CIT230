...
var apiURLstringForecast = "https://api.openweathermap.org/data/2.5/forecast?" + param + "&APPID=6a18fdc3fb96886bfb7ee69a25df0b86&units=imperial";
...
//fill first day information
   ...
   var forecastDate = output[0].dt_txt;
    ...
    document.getElementById("topIcon").src = iconURL;
